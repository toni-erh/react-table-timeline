...
const rows = data.map((_, i) => ({ index: i, id: i.toString(), children: [{ index: i, id: i.toString() + '-1' }] }))
      ...
      <div style={{ padding: 16, border: "3px solid #ccc", borderRadius: 8, height: 400 }}>
        <Table
          ...
          onRowRangeChange={(requestedRows) => {
            ...
            setLoadedRows(rows.slice(requestedRows.firstFirstLevelIndex, requestedRows.lastFirstLevelIndex))
          }}
        />
      </div>
    </div>
